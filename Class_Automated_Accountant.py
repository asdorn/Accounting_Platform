class Accountant():
    ...
    def show_balance(self):
        ...
        print("\nAssets total sum:\t", self.assets_total_value_sum)
        print("\nShort term Liabilities")
        ...
        self.profit_loss()
        print("\nStatments in Equity")
        print("Issue:\t", self.shares_and_premia)
        print("Net Profit:\t", self.net_profit)
        print("Dividends distributed:\t", self.dividend)
        print("Equity end of year:\t",
              self.equity_total_value_sum + self.shares_and_premia + self.net_profit - self.dividend)
        print("\nFinancial ratio")
